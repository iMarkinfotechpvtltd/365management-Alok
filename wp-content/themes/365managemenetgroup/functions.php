...
function Library_init() {
	$labels = array(
		'name'               => _x( 'Librarys', 'post type general name', 'your-plugin-textdomain' ),
		'singular_name'      => _x( 'Librarys', 'post type singular name', 'your-plugin-textdomain' ),
		'menu_name'          => _x( 'Music Library', 'admin menu', 'your-plugin-textdomain' ),
		'name_admin_bar'     => _x( 'Librarys', 'add new on admin bar', 'your-plugin-textdomain' ),
		...
		'parent_item_colon'  => __( 'Parent Librarys:', 'your-plugin-textdomain' ),
		'not_found'          => __( 'No Librarys found.', 'your-plugin-textdomain' ),
		'not_found_in_trash' => __( 'No Librarys found in Trash.', 'your-plugin-textdomain' )
	);
...
add_image_size( 'carrer-image', 287, 724 );

add_image_size( 'about-image', 781, 782 );

add_image_size( 'about-second-image', 976, 323 );
...
add_image_size( 'third-image', 460, 194 );
add_image_size( 'fourth-image', 460, 324 );
add_image_size( 'fifth-image', 460, 268 );
